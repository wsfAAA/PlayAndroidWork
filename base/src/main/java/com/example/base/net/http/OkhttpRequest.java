package com.example.base.net.http;
...
import com.example.base.net.HttpMethod;
import com.example.base.net.RetrofitService;
import com.example.base.net.RxCreator;
import com.example.base.net.RxService;
import com.example.base.net.api.ApiService;
import com.example.base.net.callback.DownloadListener;
import com.example.base.net.callback.RxCallBack;
import com.example.base.net.interceptor.CacheInterceptor;
import com.example.base.net.interceptor.HeaderInterceptor;
import com.example.base.net.service.DownloadIntentService;
...
//        Log.e("wsf", "range = " + range + "    已下载:  " + progress + "  % " + "     totalLength:  " + totalLength);
    ...
    private RxService getRxService() {
        ...
        if (IS_CACHE) { //添加okhttp网络数据缓存
            okhttpBuilder.addInterceptor(new CacheInterceptor(MyAppliction.getApplication()));
        }
